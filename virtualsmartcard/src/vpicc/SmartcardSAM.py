...
#
import SmartcardFilesystem, TLVutils #,CryptoUtils 
...
class Secure_Messaging(object):
    ...
    def __parse_SM(self,CAPDU,header_authentication):
        ...
        for object in structure:
            ...
            '80' to '8E' Proprietary
                ...
                if sw != 0x9000:
        			raise ValueError
                plain = CryptoUtils.strip_padding(self.CAPDU_SE.ct.algorithm,plain,padding_indicator)
                return_data.append(plain)
    ...
    def compute_cryptographic_checksum(self,p1,p2,data):
        ...
        checksum = CryptoUtils.crypto_checksum(self.current_SE.cct.algorithm, 
...
class ePass_SM(Secure_Messaging):
    ...
    def compute_cryptographic_checksum(self,p1,p2,data):
        ...
        self.ssc += 1
        checksum = CryptoUtils.crypto_checksum(self.CAPDU_SE.cct.algorithm,
